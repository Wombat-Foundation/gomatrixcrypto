...
.. code-block:: bash
   ...
   make production-serverkey-response
...
.. code-block:: bash
   ...
   make production-minting-vector

Override defaults when needed, for example:

.. code-block:: bash

   make production-minting-vector SERVER_NAME=example.com MINTING_THREADS=8 MINTING_MAX_NONCE=2048
